...
export default function EditProduct() {
  ...
  const canSubmit = useMemo(() => productName && invalidCount === 0, [productName, invalidCount])

  const handleSubmit = () => {
    try {
      axios.put(`${process.env.REACT_APP_CONFIGURATION_SERVICE}/products/${productId}`, {
        productId,
        productName,
        createdDate,
        isActive,
      ...
      console.error(error)
      setErrorMessage('Error saving product. Please try again, or contact support.')
    }
  }
